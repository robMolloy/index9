...
const customerContactsResult = [
  { id: 'id1', cus_name: 'Rob Molloy', contactsid: 'idA', con_address: '+447934647667', con_cus_id: 'id1' },
  { id: 'id2', cus_name: 'Judy Molloy', contactsid: 'idB', con_address: '+447801953992', con_cus_id: 'id2' },
  { id: 'id2', cus_name: 'Judy Molloy', contactsid: 'idC', con_address: '+441442392719', con_cus_id: 'id2' },
  { id: 'id3', cus_name: 'Nick Molloy', contactsid: 'idD', con_address: '+447708040285', con_cus_id: 'id3' },
]


test('join contacts to customers ', () => {
  const customerContacts = leftJoin(contacts, 'contacts')
    .to(customers)
    .where('con_cus_id')
    .matches('id')
